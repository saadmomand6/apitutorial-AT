...
class Usermodelexample3 {
  ...
  Usermodelexample3({this.id, this.name, this.username, this.email, this.address, this.phone, this.website, this.company});

  Usermodelexample3.fromJson(Map<String, dynamic> json) {
    if(json["id"] is int) {
      id = json["id"];
    }
